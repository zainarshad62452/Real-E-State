...
import 'package:realstate/view/fillter_screen/widgets/chipviewall_item_widget.dart';
import 'package:realstate/view/fillter_screen/widgets/chipviewany_item_widget.dart';
import 'package:realstate/view/fillter_screen/widgets/chipviewany_one_item_widget.dart';
import 'package:realstate/view/fillter_screen/widgets/chipviewfree_item_widget.dart';
import 'propert_app_home_filter_controller.dart'; // ignore_for_file: must_be_immutable

class PropertAppHomeFilterScreen
    extends GetWidget<PropertAppHomeFilterController> {
  const PropertAppHomeFilterScreen({Key? key})
      : super(
          key: key,
        );
                ...
                children: List<Widget>.generate(
                  ...
                  (index) {
                    ChipviewanyOneItemModel model = controller
                        ...
                        .value[index];
                    return ChipviewanyOneItemWidget(
                      model,
                    );
                  },
                ),
